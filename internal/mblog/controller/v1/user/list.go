...
func (uc *UserController) List(c *gin.Context) {
	...
	list, err := uc.b.Users().List(c, r.Offset, r.Limit)
	if err != nil {
...
func (uc *UserController) ListUser(ctx context.Context, r *pb.ListUserRequest) (*pb.ListUserResponse, error) {
	resp, err := uc.b.Users().List(ctx, int(*r.Offset), int(*r.Limit))
	if err != nil {
		return nil, err
	}
